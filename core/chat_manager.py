...
class ChatManager(object):
    def __init__(self, data_path: str, tables_json_path: str, log_path: str, model_name: str, dataset_name:str, dataset_path:str, dataset_mode:str, lazy: bool=False, without_selector: bool=False):
    ...
    def start(self, user_message: dict):
        ...
        user_message['exec_time'] = exec_time
